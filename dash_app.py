                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            ...
                            dcc.Tooltip(
                                ...
                                content="Filter sales by date range",
                                target="date-range"
                            )
                        ], width={"size": 3, "xs": 12}),
                        dbc.Col([
...
def apply_filters(n_clicks, salesperson, car_make, car_model, car_year, start_date, end_date):
    try:
        if n_clicks is None:
...
app.clientside_callback(
    ...
    function(n_clicks, tab_value) {
        if (n_clicks) {
            document.querySelector(`#nav-${tab_value}`).click();
        }
